...
Original file is located at
    https://colab.research.google.com/drive/1AHopS_uuKbprxAdeLRbL_DqAuub7By3P
"""

# =========================
# Data2Vec ile .wav Ses Sınıflandırma - Google Colab (Düzenlenmiş)
# =========================
...
def evaluate_model(model, test_loader, device, class_names, return_probs=False):
    ...
    for i in range(len(class_names)):
        if np.sum(y_true_bin[:, i]) == 0:
            print(f"Uyarı: Test setinde '{class_names[i]}' sınıfı yok, ROC eğrisi çizilemez.")
            continue
...
print("=== Data2Vec SES SINIFLANDIRMA EĞİTİMİ ===")
...
if len(data_paths) == 0:
    ...
    checkpoint = torch.load('best_data2vec_model.pth', map_location=device)
    ...
    if os.path.exists('best_data2vec_model.pth'):
        files.download('best_data2vec_model.pth')
        print("Model dosyası indirildi: best_data2vec_model.pth")
    ...
    print("1. best_data2vec_model.pth dosyasını bilgisayarınıza indirin")
