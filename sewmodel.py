...
Original file is located at
    https://colab.research.google.com/drive/1xYpF5JAhxecaJJoeDM3OWvAiJMHIQg4h
"""

# =========================
# SEW ile .wav Ses Sınıflandırma - Google Colab
# =========================

# Gerekli kütüphaneleri yükle/güncelle
...
class AudioWavDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # SEW için 16kHz'e yeniden örnekle
        if sr != 16000:
            wav = torchaudio.transforms.Resample(orig_freq=sr, new_freq=16000)(wav)
        label = self.labels[idx]
        return wav, label

# 4. Collate Function (SEW için)
...
# 6. Ana Pipeline
print("=== SEW SES SINIFLANDIRMA EĞİTİMİ ===")
...
if len(data_paths) == 0:
    ...
    if os.path.exists('best_sew_model.pth'):
        ...
        print("Model dosyası indirildi: best_sew_model.pth")
    ...
    print("1. best_sew_model.pth dosyasını bilgisayarınıza indirin")
